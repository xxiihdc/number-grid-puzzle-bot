...
- [x] T001 [P] [US1] Add controlled-board line-window feature tests in `tests/test_training_features.py`
- [x] T002 [US1] Implement shared four-direction line-window extraction and four new pool features in `bot/features.py`
- [x] T003 [US1] Run `python3 tests/test_training_features.py` and `python3 tests/test_bot.py`
...
- [x] T004 [P] [US3] Add legacy chromosome expansion and oversized rejection tests in `tests/test_training_weights.py`
...
- [x] T006 [US3] Run `python3 tests/test_training_weights.py` and `python3 tests/test_training_replay.py`
...
- [x] T007 [P] [US2] Add generation diagnostics persistence tests in `tests/test_training_records.py`
- [x] T008 [P] [US2] Extend backward-compatible chart-series tests in `tests/test_training_plot.py`
...
- [x] T011 [US2] Run `python3 tests/test_training_records.py` and `python3 tests/test_training_plot.py`

## Phase 4: Polish & Cross-Cutting Concerns

- [x] T012 [P] Add bounded extraction benchmark in `tests/benchmarks/test_training_feature_performance.py`
- [x] T013 Update heuristic feature documentation in `README.md`
- [x] T014 Run focused regression checks: `python3 tests/test_training_features.py`, `python3 tests/test_training_weights.py`, `python3 tests/test_training_records.py`, `python3 tests/test_training_replay.py`, `python3 tests/test_training_parallel.py`, `python3 tests/test_training_plot.py`, `python3 tests/test_bot.py`, and `python3 tests/benchmarks/test_training_feature_performance.py`
- [x] T015 Record benchmark result and plateau explanation in `specs/005-training-plateau-features/quickstart.md`
- [x] T016 Add validation-dataset replay support for interrupted best chromosomes in `bot/cli.py`, `bot/training_runner.py`, `tests/test_training_cli.py`, and `tests/test_training_replay.py`
- [x] T017 Replace continuous adaptive mutation surge with cooldown pulses in `bot/genetics.py` and add policy checks in `tests/test_training_mutation.py`
